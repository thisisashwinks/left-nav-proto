 ...
 * presets for everyone, Custom for the agency that knows exactly what it
 * wants. Written to this account's tuning profile, so another account's
 * density stays untouched.
 */
...
export function NavDensityCard({ account }: { account: Account }) {
